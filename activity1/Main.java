public class Main {
    public static void main(String[] args){
        ...
        faveBook1.author = "Uketsu";
        faveBook1.isbn = "0063433087";
        faveBook1.publicationDate = "January 14, 2025";

        Book faveBook2 = new Book("A Good Girl's Guide to Murder", "Holly Jackson", "1405293187", "May 2 2019");
        ...
        Book faveBook3 = new Book("The Housemaid", "Freida McFadden", "1538742578", "August 23, 2022");

        Book faveBook4 = new Book("Say You'll Remember Me", "Abby Jimenez", "1538759195", "April 1, 2025");
